...
class CreateGpasgUserResponsesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gpasg_user_responses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('gpasg_user_responses');
    }
}
