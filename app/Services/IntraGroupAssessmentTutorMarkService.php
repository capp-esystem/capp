...
use App\Repositories\IntraGroupAssessmentTutorMarkRepository;

class IntraGroupAssessmentTutorMarkService extends BaseService
{
    public function __construct(IntraGroupAssessmentTutorMarkRepository $repository)
    {
